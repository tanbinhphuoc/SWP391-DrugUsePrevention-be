...
namespace DrugUsePreventionAPI.Mappings
{
    public class UserMappingProfile : Profile
    {
        public UserMappingProfile()
        {
            ...
            // Ánh xạ cho admin cập nhật (bao gồm UserName)
            CreateMap<UpdateConsultantDto, User>()
                .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.Email))
                .ForMember(dest => dest.FullName, opt => opt.MapFrom(src => src.FullName))
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => "Active"))
            ...
            // Ánh xạ cho admin cập nhật
            CreateMap<AdminUpdateConsultantDto, User>()
                .ForMember(dest => dest.UserName, opt => opt.MapFrom(src => src.UserName))
                .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.Email))
                .ForMember(dest => dest.FullName, opt => opt.MapFrom(src => src.FullName))
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => "Active"))
            ...
            CreateMap<AdminUpdateConsultantDto, Consultant>()
